...
public class UserRepository {
    ...
    public long insertUser(User user) {
        ...
        try {
            ...
            values.put(DatabaseHelper.COLUMN_PASSWORD, user.getPassword()); // Gerçek uygulamada şifre hash'lenmelidir!
            ...
            Log.e(TAG, "insertUser hatası: " + e.getMessage());
        }
    ...
    public boolean isEmailExists(String email) {
        ...
        try {
            ...
            Log.e(TAG, "isEmailExists hatası: " + e.getMessage());
        } finally {
            if (cursor != null) {
                cursor.close();
            }
